function z = tx_ofdm_mod(D, par_N_FFT, par_N_CP, par_userid, switch_map, switch_scfdma, switch_graph)
%insert zeros--------------------------------------
...
if switch_graph == 1
    ...
    figure; 
    scatter(real(z), imag(z), 36, 1/255 * [33 70 122]);
    title('tx: OFDM Symbolspace');
    ylabel('Magnitude');
    grid;
end